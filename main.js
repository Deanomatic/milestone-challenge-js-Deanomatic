var inputHeightValue;
inputHeightValue = [];
var inputCharType;
inputCharType = [];

var userInput = {
	lineHeight: parseInt(document.getElementsByClassName("howTall")), 
	character: document.getElementsByClassName("whichChar");
}

userInput.lineHeight




// It is absolutely critical that you read each of these requirements because as a professional
// you will be expected to completely understand what you are expected to do. If you submit code
// that does not fulfill the requirements, you will be sent to your room with no dinner.
...
// _(as long as the cursor is in one of the input fields)_, or click a button that is labeled "Grow your tree" and 
//the tree should be shown in the console. This requires you to add an event listener to the button, as well as an 
